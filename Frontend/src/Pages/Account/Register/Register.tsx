...
<div className={style.conPasswordField}>
<label>Confirm Password</label>
<input type="password" />
</div>

<div className={style.AreYouRead}>
    <input type="checkbox" />
    <label>
    I have read and agree to GreenNest's Service</label>
</div>
...
<span onClick={changeToRegister} className={style.changeSignIn}>Sign in 
